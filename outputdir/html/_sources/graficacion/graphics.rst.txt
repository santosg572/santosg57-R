...
* **Axis**	Función genérica para agregar un eje a un gráfico
* **abline**                 Agregar líneas rectas a un gráfico
* **arrows**                  Agregar flechas a un gráfico
* **assocplot**               Parcelas de asociación
* **axTicks**                 Ubicaciones de las marcas de verificación del eje de cálculo
* **axis**                    Agregar un eje a un gráfico
* **axis.POSIXct**            Funciones de representación gráfica de fecha y fecha-hora
* **barplot**                 Gráficos de barras
* **box**                     Dibujar un cuadro alrededor de una parcela
* **boxplot**                 Diagramas de caja
* **boxplot.matrix**          Dibuje un diagrama de caja para cada columna (fila) de una matriz
* **bxp**                     Dibujar diagramas de caja a partir de resúmenes
* **cdplot**                  Gráficas de densidad condicional
* **clip**                    Establecer región de recorte
* **contour**                 Contornos de visualización
* **coplot**                  Parcelas de acondicionamiento
* **curve**                   Dibujar gráficos de funciones
* **dotchart**                Diagramas de puntos de Cleveland
* **filled.contour**          Gráficos de nivel (contorno)
* **fourfoldplot**            Parcelas cuádruples
* **frame**                   Crear/Iniciar un nuevo marco de trama
* **graphics-package**        El paquete de gráficos R
