...
Title:           The R Stats
                 Package
Author:          R Core Team and
                 contributors
                 worldwide
Maintainer:      R Core Team
                 <do-use-Contact-address@r-project.org>
Contact:         R-help mailing
                 list
                 <r-help@r-project.org>
Description:     R statistical
                 functions.
...
in the following vignettes in
directory
‘/Library/Frameworks/R.framework/Resources/library/stats/doc’:

reshape: Using the reshape
   function (source, pdf)
